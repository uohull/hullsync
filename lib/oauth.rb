# Downloaded from https://github.com/cburnette/boxr/blob/master/examples/oauth.rb
...
puts tokens
File.write(ENV['BOX_ACCESS_TOKEN_FILE'], tokens.access_token)
File.write(ENV['BOX_REFRESH_TOKEN_FILE'], tokens.refresh_token)
